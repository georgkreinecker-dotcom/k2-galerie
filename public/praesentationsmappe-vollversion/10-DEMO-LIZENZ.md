...
**Schritt 6:** Du hast die Mappe **gelesen** – **jetzt** kannst du **ohne Risiko** **fühlen**, ob die Oberfläche zu **dir** passt. **Demo zuerst** – **dann** entscheidest **du** über die Lizenz.

**ök2** ausprobieren – Demo-Galerie im Browser, keine Anmeldung. Unter **Einstellungen / Stammdaten** wählst du **Mein Weg** – **dieselbe** Logik wie in **[Für wen](03-FUER-WEN.md)**; nach dem Lizenzstart mit **deinen** Daten. Zur eigenen Galerie: Lizenz erwerben (Basic, Pro, Pro+, Pro++, VK2), gleiche Oberfläche, eigene Daten.

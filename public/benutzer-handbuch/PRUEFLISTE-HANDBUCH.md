...
## ✅ Bereits geprüft (einheitlich)

| Punkt | Befund |
|-------|--------|
| **Ansprache** | Durchgängig **Sie** („Sie öffnen“, „Ihre Galerie“, „Sie können“) – einheitlich. |
| **Lesbarkeit** | Fließtext, klare Überschriften, Absätze – kein Stichpunkt-Chaos, kein Buchhaltungs-Look. |
| **Fachbegriffe** | „Tabs“ wird als „Registerkarten“ erklärt; sonst Alltagssprache. |
| **Hilfe-Hinweis (Kapitel 4)** | „Link Hilfe oder Handbuch“ – ist in der App jetzt vorhanden (Willkommen + Admin Einstellungen). |

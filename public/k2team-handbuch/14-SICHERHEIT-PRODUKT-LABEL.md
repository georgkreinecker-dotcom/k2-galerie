...
### 6. K2 vs. Kreinecker (öffentliche Galerie) – keine Datenvermischung

- **Begriffe:** K2 = unsere Galerie (K2 Galerie Kunst&Keramik). Kreinecker = öffentliche Galerie (technisch Tenant „oeffentlich“, früher Demo).
- Auf Kreinecker-/oeffentlich-Routen **niemals** K2-Daten (k2-artworks, k2-stammdaten-*) lesen/schreiben.
- Kreinecker nur in `k2-oeffentlich-*` Keys; Admin-Kontext immer prüfen.

...
- **Deckblatt (Druck/PDF):** `pm-deckblatt-musterfamilie-home.png` – **Startseite** Musterfamilie Huber (Navigation, Willkommensbereich, Kacheln „Was möchtest du tun?“); wird mit **`pm=1&deckblatt=1`** erzeugt (minimale Text-Chrome). Wird in `K2FamiliePraesentationsmappeKundePage` **unter** dem Teal-Deckblatt-Kopf als A4-Bild gezeigt. Ältere Datei `pm-familie-einstieg.png` kann bei Bedarf für andere Zwecke bleiben.

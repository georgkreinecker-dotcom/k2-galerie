...
- **Kunst (Mein Weg = Kunst & Galerie):** Wie heute – **Vita** (Person 1/2), gleiche Oberfläche, gleiche Speicherung. Label „Vita“.
...
- **Stammdaten-Richtung:** „Mein Weg“ (ök2) liefert schon Typ/Kategorie; Story-Feld ist die logische Ergänzung – bei Kunst = Vita, bei anderen = Produktstory/Ideen-Story.
...
- **Galerie-Stammdaten** (K2/ök2): Neues Feld **`story`** (optional, string).  
  - Bei **Kunst** (Mein Weg = kunst): wird nicht genutzt; PR nutzt weiter **martina/georg.vita** (und bio).  
...
- **Ort:** Stammdaten-Tab, nahe „Mein Weg“ (oder eigener Block „Deine Story für Presse & PR“).
- **Wenn Mein Weg = Kunst:**  
...
- **Option A:** Bei ök2 und Mein Weg ≠ Kunst: Link „Vita“ in der Galerie durch **„Unsere Story“** ersetzen (zeigt **gallery.story** nur an, Bearbeitung im Admin).  
...
3. UI: Story-Textarea im Admin (ök2) bei „Mein Weg ≠ Kunst“ + Speichern in gallery.story.  

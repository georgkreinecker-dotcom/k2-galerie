...
- **Heute:** (1) **Sync iPad ↔ Mac:** Few-Works-Fallback entfernt (BUG-023). (2) **„Bilder 0030–0039 bereinigen“ – Fotos blieben sichtbar:** … BUG-024. (3) **„Bilder sind noch immer da“:** Export/Supabase + setAllArtworksSafe 30–39-Fix. (4) **„In der Galerie fehlen Fotos die in den Werken vorhanden sind“ (z. B. K2-K-0013, K2-K-0014):** … (5) **30–39: Keine alten Repo-Bilder, neue Bilder sichtbar:** Georg: Nicht wieder 30–39 unterdrücken – neue Fotos von heute sollen rein; Problem war, dass **zwei alte** Bilder (030, 031) aus dem Repo/Vercel-Static geladen wurden (gelöschte Dateien). **Umsetzung:** Nur für 30–39: **Vercel-Static-Fallback** abgestellt (kein werk-K2-K-0030.jpg … 0039.jpg aus Repo). Alte URLs aus Payload/Ref für 30–39 werden verworfen (imageUrl leer → Platzhalter, bis neues Bild aus IndexedDB/Server da ist). Neue Bilder (IndexedDB, frischer Server-Payload) bleiben normal sichtbar. **Stellen:** artworkImageStore.ts (resolveArtworkImages), GalerieVorschauPage.tsx (loadArtworksResolvedForDisplay), ScreenshotExportAdmin.tsx (Werkkarten-Fallback). **Commit:** folgt.
...
- **Nächster Einstieg:** Georg testen: „Vom Server laden“ – Erfolgsmeldung/Banner schließen → Werke sollen sichtbar bleiben. Zuerst vom iPad „An Server senden“, dann Mac „Aktuellen Stand holen“.

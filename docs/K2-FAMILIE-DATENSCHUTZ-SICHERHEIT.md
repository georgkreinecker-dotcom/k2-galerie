...
| **Zugriff nur für die Familie** | Nur Nutzer*innen, die **zu dieser Familie eingeladen** sind (Einladungslink / Familien-Code / Konto-Zuordnung), können die Daten dieser Familie lesen und – je nach Rolle – bearbeiten. Kein „Durchsuchen“ anderer Familien durch uns oder Dritte. |

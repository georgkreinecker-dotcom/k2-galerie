...
| **Tests / QS vor Commit** | Vor jedem Commit: Tests + Build grün. | npm run test, npm run build; src/tests/*. | **docs/QUALITAETSSICHERUNG.md**, **.cursor/rules/qs-standard-vor-commit.mdc**. |

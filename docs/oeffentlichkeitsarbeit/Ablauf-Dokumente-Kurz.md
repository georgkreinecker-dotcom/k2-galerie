...
- **Wo:** Admin → Eventplanung → Event wählen → „Presse“, „Newsletter“, „Plakat“, „Social“, „Event-Flyer“ oder „PR-Vorschläge (alle)“.
- **Was passiert:** Content wird aus Event + Stammdaten + Werbelinie (tenantConfig) erzeugt. Noch nicht gespeichert.

## 2. Dokument anlegen

- **Klick** auf einen der PR-Vorschläge → Platzhalter-Eintrag wird in der Dokumenten-Liste angelegt (localStorage, Key je Kontext: K2 / ök2 / VK2).
- **Dokument** erscheint unter der Rubrik des Events in „Öffentlichkeitsarbeit“.

...
| **Kurzbezeichnungen Lizenzlinien (L)** | **docs/KURZBEZEICHNUNGEN-L-LIZENZVERSION.md** | **LK2** = ök2, **LVK2** = VK2, **LFK2** = K2 Familie; **K2** = echte Galerie ohne L. Für Briefing, Doku, KI-intern; UI-Keys unverändert. |

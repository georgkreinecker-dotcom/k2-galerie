...
- **STRIPE-LIZENZEN-GO-LIVE.md** – **Die nächsten 3 Schritte (Stripe/Lizenzen):** Supabase-SQL in Reihenfolge, Vercel Env, Stripe Webhook. Kurzcheckliste; verweist auf **STRIPE-ANBINDUNG-SCHRITT-FUER-SCHRITT.md**.

...
- **AGENT-KONZEPT.md** – **Schlanker smarter Agent:** Analyse Georgs Denk- und Handlungsweise, Spezifikation (Stand, Offen, Proaktiv), eine Briefing-Datei + Skript. Kein zweiter Joe – Orientierung und Vorschläge.
- **AGENTEN-BRIEFING.md** – **Session-Start:** Generiert mit `npm run briefing`. Stand, Offen, Proaktiv; bei „Hi Joe“ / ro mit lesen. Quelle: DIALOG-STAND + Grafiker-Tisch (+ optional git).

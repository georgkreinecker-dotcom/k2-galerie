...
- **ADMIN-QR-LIZENZ-OEK2-ABLAUF.md** – **Admin-QR (Lizenznehmer, ök2-Demo, Lizenz-Erfolg):** Drei Stellen, URLs (`/admin` vs. `?context=oeffentlich`), eine technische Quelle (`LicenseeAdminQrPanel`, `publicLinks`, Server-Stand + Cache-Bust), Prüfliste vor Commit (Panel-Datei nicht vergessen).

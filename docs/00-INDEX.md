...
- **OEFFENTLICHKEITSARBEIT-QR-UND-LINK-REGEL.md** – **Öffentlichkeitsarbeit – QR vs. Link (verbindlich):** Plakate, Event-Flyer, Newsletter, QR-Plakate = automatisch mit User-/Vereins-QR versehen (keine Extra-Eingabe). Social Media, Presseaussendung = nur Link nötig. (Georg 17.03.26)

...
- **GAMIFICATION-POTENTIALE-K2.md** – **Gamification (leicht):** Erster Baustein Admin Eventplan → Öffentlichkeitsarbeit (Hero + Meilensteine); Tabelle weiterer Bereiche (Werke, Galerie gestalten, Guide, …) mit Regeln (kein Druck, kein Datenverlust, K2-Kern).

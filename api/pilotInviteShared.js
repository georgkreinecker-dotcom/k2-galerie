...
import { buildPilotInviteEmailHtml } from './pilotInviteEmailHtml.js'
...
export async function sendPilotInviteViaResend({
  ...
  const html = buildPilotInviteEmailHtml({ name, greetingName, inviteUrl, contextLabel, inviteContext })

...
/**
 * Gleiche Logik wie in pilotInviteShared.js – hier lokal, damit kein Named-Export
 * vom Shared-Modul nötig ist (Vite-Dev / manche Bundler: „does not provide an export named …“).
 */
function buildPilotInviteEmailPlainText({ name, greetingName, inviteUrl, contextLabel, inviteContext = 'oeffentlich' }) {

...
| Ort | Inhalt | Wofür |
|-----|--------|-------|
| **APf** `/projects/k2-galerie/texte-schreibtisch` | Bereich **Pilot & Testuser** (Zettel): **Neuer Test-Pilot** → `/zettel-pilot-form`, **Testuser-Mappe** (Dokumente, Anmeldung, Katalog) → `/testuser-anmeldung` | Zettel griffbereit; in der APf unter **Praktisch** → **Testuser-Mappe** / Texte-Schreibtisch. |

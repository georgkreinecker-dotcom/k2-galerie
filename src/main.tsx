...
const iframeGalleryRoute =
  typeof window !== 'undefined' && window.location.pathname.startsWith('/g/')
if (rootElement && inIframe && !embeddedInApf && !k2DocViewerEmbed && !k2PlakatEmbed && !liveTemplateEmbed && !iframeGalleryRoute) {
  ...
  rootElement.innerHTML = `
    <div style="padding: 2rem; color: rgba(255,245,240,0.95); background: #1a0f0a; min-height: 100vh; font-family: system-ui; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;">
      ...
      <a href="${fullUrl}" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0.75rem 1.5rem; background: #ff8c42; color: #1a0f0a; border: none; border-radius: 8px; font-size: 1rem; font-weight: 600; text-decoration: none; cursor: pointer;">Im Browser öffnen</a>

...
const ROUTE_META: { path: string | RegExp; meta: PageMeta }[] = [
  ...
  { path: '/projects/k2-galerie/galerie-oeffentlich', meta: { title: 'Demo-Galerie – ök2', description: 'ök2 Demo – So präsentieren Künstler:innen und Galerien ihre Werke mit der K2-Plattform.' } },
  { path: '/projects/k2-galerie/galerie-oeffentlich-vorschau', meta: { title: 'Demo Vorschau – ök2', description: 'Vorschau der ök2-Demo-Galerie – K2-Plattform für Künstler:innen und Galerien.' } },

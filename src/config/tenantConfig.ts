...
/** ök2: Ein Bild pro Kategorie für Musterwerke. Inline-SVG (data-URI), damit die 5 Werkkarten immer laden – keine externen URLs, sonst Platzhalter/Fragezeichen bei CORS oder Netzwerkfehlern. */

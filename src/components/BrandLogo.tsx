/**
 * Brand-Logo – links oben (aktuell in App.tsx nicht gemountet).
 * Gleicher Einstieg wie Galerie: **Eingangstor** `/entdecken` (OEK2_NEUER_BESUCHER_EINSTIEG_ROUTE).
 */

import { Link } from 'react-router-dom'
import { PRODUCT_BRAND_NAME } from '../config/tenantConfig'
import { OEK2_NEUER_BESUCHER_EINSTIEG_ROUTE } from '../config/navigation'

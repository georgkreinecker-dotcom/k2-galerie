...
const DEFAULT_ITEMS: PanelItem[] = [
  ...
  { id: 'k2-markt', label: '📁 K2 Markt', page: 'k2-markt', url: PROJECT_ROUTES['k2-galerie'].k2Markt, color: 'linear-gradient(135deg, rgba(34,197,94,0.15), rgba(22,163,74,0.08))', border: 'rgba(34,197,94,0.35)' },

...
const DEFAULT_ITEMS: PanelItem[] = [
  ...
  { id: 'k2-familie', label: '👨‍👩‍👧‍👦 K2 Familie', page: 'k2-familie', url: PROJECT_ROUTES['k2-familie'].meineFamilie, color: 'linear-gradient(135deg, rgba(13,148,136,0.22), rgba(20,184,166,0.12))', border: 'rgba(13,148,136,0.5)' },
...
const K2_FAMILIE_HOME = PROJECT_ROUTES['k2-familie'].meineFamilie

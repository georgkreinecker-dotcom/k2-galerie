  ...
  return (
    ...
    >
      ...
      <section id="mok2-sichtbarkeit-werbung" style={{ marginBottom: '2rem', breakInside: 'avoid' }}>
        ...
        <p style={{ marginTop: '0.5rem', fontSize: '0.85rem', color: 'rgba(255,255,255,0.85)' }}><strong>Medienverteiler:</strong> <code style={{ fontSize: '0.82em', color: '#5ffbf1' }}>docs/MEDIENVERTEILER-EROEFFNUNG.md</code> – regional (OÖN, MeinBezirk, Tips, ORF OÖ) + leicht überregional (Standard, Presse).</p>

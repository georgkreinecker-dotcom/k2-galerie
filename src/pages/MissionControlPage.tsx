        ...
        >
          <header style={{ marginBottom: '1.1rem' }}>
            ...
            <p style={{ margin: '0.4rem 0 0', fontSize: '0.85rem', color: '#94a3b8', lineHeight: 1.45 }}>
              Galerie-Sichten (einmal pro Browser-Sitzung) und Pilot-Kunden im Register.
            </p>
          </header>
          ...
          >
            {visitAreas?.map((row) => {
              ...
              return (
                ...
                >
                  <div style={{ fontSize: '0.78rem', color: '#cbd5e1', marginBottom: '0.35rem' }}>{row.label}</div>
                  <div style={{ fontSize: '1.65rem', fontWeight: 800, color: row.color, lineHeight: 1.1 }}>
                    {row.value}
                  </div>
                  {row.detail ? (
          ...
          <p style={{ margin: '0 0 0.75rem', fontSize: '0.8rem', color: '#94a3b8' }}>
            Besucher auf eigener Domain · Summe Pilot-Kunden:{' '}

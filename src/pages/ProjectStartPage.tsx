...
export default function ProjectStartPage() {
  ...
  const quickLinks = [
    { label: 'Phase 1', anchor: `${routes.missionControl}#phase1` },
    { label: 'Phase 2', anchor: `${routes.missionControl}#phase2` },
    { label: 'Phase 3', anchor: `${routes.missionControl}#phase3` },
    { label: 'Phase 4', anchor: `${routes.missionControl}#phase4` },

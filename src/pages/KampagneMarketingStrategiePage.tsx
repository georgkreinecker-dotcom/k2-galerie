/**
 * Kampagne Marketing-Strategie – eigene Mappe (in K2 Galerie).
 * Erste Zwischenergebnisse: Auftrag, ausgearbeitete Strategie. Quelle: public/kampagne-marketing-strategie/
 */
    ...
    <div className="mission-wrapper">
      <div className="viewport" style={{ padding: '1.5rem 2rem' }}>
        <header className="no-print" style={{ marginBottom: '1.5rem' }}>
          <div>
            <h1 style={{ margin: 0, color: '#5ffbf1', fontSize: '1.75rem' }}>📁 Kampagne Marketing-Strategie</h1>

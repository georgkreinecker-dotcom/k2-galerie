      ...
      <div style={{ maxWidth: '560px', margin: '0 auto', padding: '2rem 1.5rem', background: '#fffefb', color: '#1c1a18', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
        ...
        <div className="prospekt-body">
          ...
          <p style={{ fontSize: '0.85rem', lineHeight: 1.45, margin: '0 0 0.5rem' }}>
            <strong>Galerie & Werke:</strong> Fotos, Titel, Preis, Kategorien; Vorschau; Veröffentlichen; gleicher Stand auf Mac, Tablet und Handy. <strong>Admin:</strong> Werke, Design (Farben, Texte, Bilder), Einstellungen, Schritt-für-Schritt-Assistent, Kassa, Lager, Werkkatalog, Event- und Medienplanung. <strong>Kassa & Kassabuch:</strong> Verkauf erfassen (Shop oder „Als Kasse öffnen“); ab Pro: Kassabuch (Eingänge); ab Pro+: Ausgänge, Bar, Beleg (QR/Foto), PDF-Export. <strong>Event- und Medienplanung:</strong> Events anlegen, Einladungen, Mediengenerator, Verteiler und Social Media – aus Stammdaten und Event-Daten. <strong>Werbeunterlagen:</strong> Newsletter, Plakat, Flyer aus einer Quelle im Galerie-Design.
          </p>
